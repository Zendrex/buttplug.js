...
| --- | --- | --- | --- |
| `"pulse"` | Square wave on/off | Yes | Vibrate, Rotate, Oscillate, Constrict |
| `"wave"` | Smooth sine wave oscillation | Yes | Vibrate, Rotate, Oscillate, Constrict |
| `"ramp_up"` | Gradual increase to maximum | No | Vibrate, Rotate, Oscillate, Constrict |
| `"ramp_down"` | Gradual decrease to zero | No | Vibrate, Rotate, Oscillate, Constrict |
| `"heartbeat"` | Ba-bump heartbeat rhythm | Yes | Vibrate, Rotate, Oscillate, Constrict |
| `"surge"` | Build to peak then release | No | Vibrate, Rotate, Oscillate, Constrict |
